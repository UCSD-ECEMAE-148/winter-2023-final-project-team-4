...
# VESC class from given actuator.py
class VESC:
    '''
    ...
    # Added the following functions for different movement options
    # Throttle is range [-1,1], move_time is in seconds, angle is from [-60,60]
    def move_time(self, throttle, move_time):
        self.v.set_duty_cycle(throttle * self.percent)
